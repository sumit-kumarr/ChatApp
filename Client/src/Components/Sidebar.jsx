...
const Sidebar = () => {
    ...
    return (
       ...
       h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ''}`}>
            <div className='pb-5'>
                <div className='flex justify-between items-center'>
                    <img src="logo1.png" alt="logo" className='max-w-15' />
                ...
                <div className='bg-[#282142] rounded-full items-center gap-2 py-3 px-4 mt-5 '>
            ...
            <div className='flex flex-col'>
                <div
                    onClick={() => setSelectedUser({ _id: 'chatbot', fullName: 'ChatWithAI', profilePic: "bot.png" })}
                    className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser?._id === 'chatbot' && 'bg-[#282142]/50'}`}
                >
                    <img src="bot.png" className='w-[35px] aspect-[1/1] rounded-full' />
